                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#" style="font-size: 14px;">
                            <img src="./images/OpenNMS_Logo.png" alt="OpenNMS Logo" style="width:100px;height:auto;"> Motorway Fault API Tester</a>
                    </div>
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li <% if ("home".equals(request.getAttribute("selectedPage"))) {%> class="active"  <% } %> ><a href="./home">Home</a></li> 
                            <li <% if ("log".equals(request.getAttribute("selectedPage"))) {%>  class="active"  <% }%> ><a href="./log">Log</a></li> 
