...
iso, Unsigned32, Counter64, Gauge32, ModuleIdentity, TimeTicks, Counter32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Counter64", "Gauge32", "ModuleIdentity", "TimeTicks", "Counter32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("CHUBB-TVBS-CAMERA-MIB", logicInput=logicInput, tvbsCameraAgent=tvbsCameraAgent, logicStatus=logicStatus, tvbsCameraStatusGroup=tvbsCameraStatusGroup, carriagewayText=carriagewayText, healthChange=healthChange, panMotorFault=panMotorFault, tamperDetected=tamperDetected, logicDescription=logicDescription, washerMotorFault=washerMotorFault, fluidLevelFault=fluidLevelFault, irisMode=irisMode, tamperState=tamperState, zoomMotorFault=zoomMotorFault, panPos=panPos, faultState=faultState, tvbsNotificationGroup=tvbsNotificationGroup, logicInputState=logicInputState, focusMode=focusMode, cameraHealth=cameraHealth, tvbsNotifications=tvbsNotifications, cameraConformance=cameraConformance, logicEntry=logicEntry, tvbuCameraCommsFault=tvbuCameraCommsFault, logicID=logicID, tvbsCameraObjects=tvbsCameraObjects, compassDirection=compassDirection, cameraStatus=cameraStatus, tiltMotorFault=tiltMotorFault, apertureMotorFault=apertureMotorFault, PYSNMP_MODULE_ID=tvbsCamera, tiltPos=tiltPos, focusMotorFault=focusMotorFault, tvbsCamera=tvbsCamera, tvbsCompliance=tvbsCompliance, videoSignalFault=videoSignalFault, healthChangeReason=healthChangeReason, logicInputChange=logicInputChange, focusPos=focusPos, wiperMotorFault=wiperMotorFault, cameraCompliances=cameraCompliances, zoomPos=zoomPos, heaterFault=heaterFault, logicTable=logicTable, cameraGroups=cameraGroups, tvbsCameraObjectGroup=tvbsCameraObjectGroup, configPlugFault=configPlugFault, tvbsNotificationPrefix=tvbsNotificationPrefix, comms=comms, housingTamper=housingTamper, commsStateChange=commsStateChange, tvbsCameraHealthGroup=tvbsCameraHealthGroup, commsStateReason=commsStateReason)
